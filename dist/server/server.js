...
function Icon(props) {
    ...
    switch (iconName) {
        ...
        case 'statistic':
            {
                iconSvg = ((0, jsx_runtime_1.jsx)("svg", Object.assign({ width: size, height: size, viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: (0, jsx_runtime_1.jsx)("path", { d: "M6 16H10V0H6V16ZM0 16H4V8H0V16ZM12 5V16H16V5H12Z", fill: "#DC3E22" }) })));
            }
            break;
        default:
...
function Timer() {
    ...
    const [time, setTime] = (0, react_1.useState)(WORK);
    const [part, setPart] = (0, react_1.useState)('work');
    const [mode, setMode] = (0, react_1.useState)('stop');
    const addTime = () => {
    ...
    if (!task) {
        return (0, jsx_runtime_1.jsx)("div", { children: "123" });
    }
...
const jsx_runtime_1 = __webpack_require__(0);
const button_css_1 = __importDefault(__webpack_require__(41));
